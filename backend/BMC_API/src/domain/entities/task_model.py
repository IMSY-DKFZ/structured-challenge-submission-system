...
class TaskModel(Base):
    ...
    task_challenge = relationship("ChallengeModel", back_populates="challenge_tasks", lazy="selectin")
    ...
    task_platform_sharing_information = Column(String)
    ...
    task_quantity_of_data = Column(String)
    task_organizing_team_clinicians = Column(String)
    task_statistical_analyses_overview = Column(String)
    task_statistical_analyses_precision_performance_estimates = Column(String)
    task_statistical_analyses_performance_variability = Column(String)
    task_statistical_analyses_rankings_variability = Column(String)
    task_statistical_analyses_test_for_significance = Column(String)
    task_statistical_analyses_missing_data_handling = Column(String)
    task_statistical_analyses_software = Column(String)
