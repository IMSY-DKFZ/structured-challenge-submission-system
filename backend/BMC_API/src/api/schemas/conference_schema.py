...
class ConferenceModelBase(BaseModel):
    """
    Base schema for the Conference object.
    """

    name: str = Field(..., description="The full name of the conference.")
    information: Optional[str] = Field(None, description="Additional details about the conference.")
    venue: Optional[str] = Field(None, description="The venue of the conference.")
    city: Optional[str] = Field(None, description="The city where the conference is held.")
    country: Optional[str] = Field(None, description="The country where the conference is held.")
    proposal_start_date: datetime = Field(..., description="Start date for proposal submissions.")
    proposal_end_date: datetime = Field(..., description="End date for proposal submissions.")
    start_date: datetime = Field(..., description="Start date of the conference.")
    short_name: str = Field(..., description="A short name or abbreviation for the conference.")
