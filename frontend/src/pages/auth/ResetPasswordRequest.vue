<template>
  <ContentCard
    headline="Reset Password Request"
    subtitle=""
    :show-logo="false"
    :backlink="backlink"
    :showLinks="false">
    ...
    <div class="pb-3">
      Using this form you can request a password reset. Please provide your email address. If the
      data matches our records, you will receive a mail with further instructions. If you are unable
      to recover your password, please
      <router-link :to="{ name: 'Contact' }">contact technical support</router-link>.
    </div>
    <VueForm
      @submit-event="resetRequest"
      actionBtn="Reset password request"
    ...
    <div class="text-center d-flex flex-column">
      <span class="pb-3 lh-1"
        >If you have received password reset token via e-mail, you can complete the process at
      ...
      apiPost(`user/reset_password_request?email=${this.email}`)
        .then(() => {
          ...
          useToastAlertStore().showAlert(
            'A new password has been requested. Instructions have been sent to your e-mail address.',
            'success',
            6000
          )
        })
