<template>
  <VueTextSection>
    ...
    <template #text
      >Here, you can manage the deadlines for challenge proposals and reviews.</template
    >
    <VueForm
      name="deadlines"
      :action-btn-fullwidth="false"
      action-btn="Change Deadline"
      @submitEvent="setDeadline">
      <VueInput
        label="Deadline"
        type="date"
        :required="true"
        v-model="deadline"></VueInput>
    </VueForm>
  </VueTextSection>
  <VueTextSection>
    ...
    <VueForm
      name="startDate"
      :action-btn-fullwidth="false"
      action-btn="Change starte date"
      @submitEvent="setStartDate">
      <VueInput
        label="Deadline"
        type="date"
        :required="true"
        v-model="startDate"></VueInput>
    </VueForm>
  </VueTextSection>
  <VueTextSection>
  ...
  <VueTextSection>
    ...
    <VueForm
      ...
      <VueInput
        ...
        type="checkbox"
        :required="true"
        v-model="email.to.organizer">
      </VueInput>
      <VueInput
        label="Sub Admin"
        type="checkbox"
        :required="true"
        v-model="email.to.subAdmin">
      </VueInput>
      <VueInput
        label="Admin"
        type="checkbox"
        :required="true"
        v-model="email.to.admin">
      </VueInput>
      <VueInput
        label="Subject"
        type="text"
        :required="true"
        text-min-length="5"
        v-model="email.subject"></VueInput>
      <VueInput
        label="Message"
        type="textarea"
        :required="true"
        v-model="email.message"></VueInput>
    </VueForm>
  </VueTextSection>
  ...
  <VueTextSection v-if="useAuthStore().adminOnly">
    ...
    <VueForm
      name="prefix"
      :action-btn-fullwidth="false"
      action-btn="Update mailing list"
      @submitEvent="updateMailingList">
      <VueInput
        label="Technical mailing list prefix"
        type="text"
        :required="true"
        v-model="mailingPrefix"></VueInput>
      <VueInput
        label="Chairs mail addresses"
        type="email"
        :required="true"
        v-model="chairsMailAddress"></VueInput>
    </VueForm>
  </VueTextSection>
</template>
